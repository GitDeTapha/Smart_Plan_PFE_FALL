...
def plot_histograms_numeric(data):
    ...
    """
    # Reduce figure size
    fig, axes = plt.subplots(nrows=3, ncols=1, figsize=(6, 8), dpi=72)
    fig.subplots_adjust(hspace=0.5)
    fig.suptitle('Histograms of Key Numeric Variables', fontsize=10)
    ...
    for ax, var, bins, xlim in zip(axes, variables, bins_settings, xlims):
        ...
        ax.set_title(f'Histogram of {var}', fontsize=8)
        ax.set_xlabel(f'Values of {var}', fontsize=8)
        ax.set_xlim(xlim)
...
def plot_top_category_counts(data):
    ...
    plt.figure(figsize=(6, 4 * len(categorical_vars)), dpi=72)
    ...
    for i, var in enumerate(categorical_vars):
        ...
        plt.title(f'Count Plot of {var}', fontsize=10)
        plt.xlabel(f'{var} Categories', fontsize=8)  
...
def analyze_working_patterns(data):
    ...
    plt.title('Patients by Day of the Week', fontsize=10)
    plt.xlabel('Day (0=Mon, 6=Sun)', fontsize=8)
    plt.ylabel('Number of Patients', fontsize=8)
    plt.xticks(range(0, 7), ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'], fontsize=7)
    plt.yticks(fontsize=7)
    plt.tight_layout()
    plt.show()
    ...
    plt.title('Patients by Hour of the Day', fontsize=10)
...
def visualize_outliers(data):
    ...
    plt.title('Outlier Counts in Numeric Columns', fontsize=10)
...
def plot_consultation_counts(data):
    ...
    plt.axis('equal')
    plt.title('Consultations per Category', fontsize=10)
    plt.tight_layout()
    plt.show()  
...
def plot_no_show_comparaison(data):
    ...
    plt.ylabel('Number of No-Shows', fontsize=8)
    plt.title('No-Shows: Community Care vs VHA', fontsize=10)
...
def plot_patient_flow(data, datetime_col='activitydatetime', disp_col='NoShow'):
    ...
    plt.title('No-Show Rate by Hour', fontsize=10)
    plt.xlabel('Hour of Day', fontsize=8)
    plt.ylabel('Average No-Show Rate', fontsize=8)
    plt.xticks(range(0, 24), fontsize=7)  
    plt.yticks(fontsize=7)
    plt.tight_layout()
    plt.show()
    ...
    plt.title('No-Show Rate by Day of Week', fontsize=10)
    ...
    plt.title('No-Show Rate by Day of Month', fontsize=10)
...
def plot_patient_flow_segmented(data, disp_col='NoShow', estimator=np.mean):
    ...
    plt.title('No-Show Rate by Day Across Weeks', fontsize=10)
    plt.xlabel('Day of the Week', fontsize=8)
    plt.ylabel('Estimated No-Show Rate', fontsize=8)
    plt.xticks(range(1, 8), day_labels, rotation=45, fontsize=7)
    plt.yticks(fontsize=7)
    plt.legend(title='Week Segment', fontsize=7)
    plt.grid(True)
    plt.tight_layout()
    plt.show()
...
def plot_no_show_rate_by_typecare(data):
    ...
    plt.figure(figsize=(6, 4), dpi=72)
    plt.bar(categories, values, color=colors)
    plt.ylabel('No-Show Rate (%)', fontsize=8)
    plt.xticks(rotation=45, fontsize=7)
    plt.yticks(fontsize=7)
    plt.tight_layout()
    plt.show()
...
def plot_service_time_by_hour_and_weekday_vha(data):
    ...
    fig, axes = plt.subplots(nrows=1, ncols=2, figsize=(8, 4), dpi=72)
    ...
    axes[0].set_xlabel('Hour of the Day', fontsize=8)
    axes[0].set_ylabel('Average Service Time', fontsize=8)
    ...
    axes[1].set_ylabel('Average Service Time', fontsize=8)
    axes[1].legend(fontsize=7)
    axes[1].grid(True)
    axes[1].set_xticks(range(0, 7))
    axes[1].set_xticklabels(['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'], fontsize=7)
...
def plot_service_time_by_hour_and_weekday(data):
    ...
    axes[0].set_title('Service Time by Hour', fontsize=10)
    axes[0].set_xlabel('Hour of the Day', fontsize=8)
    axes[0].set_ylabel('Average Service Time (ts)', fontsize=8)
    axes[0].legend(fontsize=7)
    axes[0].grid(True)
    axes[0].set_xticks(range(0, 24))
    axes[0].tick_params(axis='both', which='major', labelsize=7)
    ...
    axes[1].set_title('Service Time by Weekday', fontsize=10)
    axes[1].set_xlabel('Day of the Week', fontsize=8)
    axes[1].set_ylabel('Average Service Time (ts)', fontsize=8)
    axes[1].legend(fontsize=7)
    axes[1].grid(True)
    axes[1].set_xticks(range(0, 7))
    axes[1].set_xticklabels(['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'], fontsize=7)
